...
library AlgebraFeeConfigurationU144Lib {
    ...
    ) internal pure returns (AlgebraFeeConfigurationU144) {
    ...
    function alpha1(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint16 _alpha1) {
        assembly {
    ...
    function alpha2(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint16 _alpha2) {
        assembly {
    ...
    function beta1(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint32 _beta1) {
        assembly {
    ...
    function beta2(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint32 _beta2) {
        assembly {
    ...
    function gamma1(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint16 _gamma1) {
        assembly {
    ...
    function gamma2(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint16 _gamma2) {
        assembly {
    ...
    function baseFee(
        AlgebraFeeConfigurationU144 config
    ) internal pure returns (uint16 _baseFee) {
        assembly {
