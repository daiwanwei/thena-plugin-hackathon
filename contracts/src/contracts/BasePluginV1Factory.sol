...
contract BasePluginV1Factory is IBasePluginV1Factory {
    ...
    /// @inheritdoc IBasePluginV1Factory
    mapping(address poolAddress => address pluginAddress)
        public
        override pluginByPool;
    ...
    function createPluginForExistingPool(
        ...
        require(
            factory.hasRoleOrOwner(
                factory.POOLS_ADMINISTRATOR_ROLE(),
                msg.sender
            )
        );
    ...
    function _createPlugin(address pool) internal returns (address) {
        ...
        IAlgebraBasePluginV1 volatilityOracle = new AlgebraBasePluginV1(
            pool,
            algebraFactory,
            address(this)
        );
    ...
    function setLimitOrderPlugin(
        address newLimitOrderPlugin
    ) external override onlyAdministrator {
